...
class Giftvoucher extends Addons
{
    ...
    public $menu_info = array(
        ...
        [
            ...
            'icon_class' => '',//字体图标class（一般为空）
            'is_control_auth' => 1,//是否有控制权限
            'hook_name' => 'sendhistoryGiftvoucher',
            'module' => 'platform'
        ],
        [
            'module_name' => '礼品券详情',
    ...
    public function __construct()
    {
        ...
        if ($this->module == 'platform') {
            ...
            $this->assign('sendhistorygiftvoucherUrl', __URL(addons_url_platform('giftvoucher://Giftvoucher/sendhistoryGiftvoucher')));
            ...
            $this->assign('sendhistorygiftvoucherUrl', __URL(addons_url_admin('giftvoucher://Giftvoucher/sendhistoryGiftvoucher')));
        }
    }
    ...
    {
        $this->assign('gift_voucher_id', (int)input('get.gift_voucher_id'));
        $this->fetch('template/' . $this->module . '/sendhistoryGiftvoucher');
    }
    public function giftvoucherSetting()
    {
        $addonsConfigSer = new \data\service\AddonsConfig();
        $info = $addonsConfigSer->getAddonsConfig('giftvoucher', $this->website_id, 0);
