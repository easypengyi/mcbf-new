...
class VslGiftVoucherRecordsModel extends BaseModel
{
    ...
    public function getVoucherHistoryDetail($condition){
        ...
        if($detail){
            ...
            ->field('vgv.is_transcoupon,vgv.start_time,vgv.end_time,vgv.desc,vgv.giftvoucher_name,vpg.promotion_gift_id,vpg.gift_name,vpg.price, sap.pic_cover_mid,sap.pic_cover_big')
