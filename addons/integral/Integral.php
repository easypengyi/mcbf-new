...
class Integral extends Addo
{
    ...
    public $menu_info = array(
        ...
        [
            ...
            'hook_name' => 'modalIntegralGoodsList',
            'module' => 'platform'
        ],
        [
            'module_name' => '赠品选择',
            ...
            'icon_class' => '',//字体图标class（一般为空）
            'is_control_auth' => 0,//是否有控制权限
            'hook_name' => 'modalIntegralGiftList',
            'module' => 'platform'
        ],
        [
            'module_name' => '优惠券选择',
            ...
            'icon_class' => '',//字体图标class（一般为空）
            'is_control_auth' => 0,//是否有控制权限
            'hook_name' => 'modalIntegralCouponList',
            'module' => 'platform'
        ],
...
//        var_dump($_COOKIE["goods_category_id"]);
        ...
        if ($goodsId > 0 || $origin_goods_id > 0 || $coupon_type_id > 0 || $gift_voucher_id > 0) {
            if($goodsId > 0){
                ...
                $goods_info = $goods->getGoodsDetail($origin_goods_id, 1);
...
//                $goods_info['img_temp_array'] = [];
    ...
    public function integralSetting()
    {
        ...
        $addons_info = $addonsConfigSer->getAddonsConfig('integral', $this->website_id, 0);
...
//        $this->assign("oneGoodsCategory", $oneGoodsCategory);
    ...
    {
        $integral_goods_id = (int)request()->get('integral_goods_id', 0);
        $this->assign('integral_goods_id', $integral_goods_id);
