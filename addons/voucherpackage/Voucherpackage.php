...
class Voucherpackage extends Addons
{
    ...
    public function updateVoucherPackage()
    {
        ...
        // var_dump(json_encode($voucher_package_info, JSON_UNESCAPED_UNICODE));exit;
    ...
    public function voucherPackageSetting()
    {
        ...
        $voucher_package_info = $addonsConfigSer->getAddonsConfig('voucherpackage', $this->website_id);
    ...
    public function selectModal()
    {
        ...
        if ($type == 'coupon_type') {
            ...
            $this->assign('title', '券包');
            $this->assign('listUrl', __URL(call_user_func('addons_url_' . $this->module, 'voucherpackage://Voucherpackage/VoucherPackageList')));
        }
