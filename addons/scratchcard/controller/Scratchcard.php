...
class Scratchcard extends baseScratchcard
{
    ...
    public function addScratchcard()
    {
        ...
        if($res){
            ...
            if($delay_time1 > 0){
                $this->smallPromotionOpenOrClose('scratch_card_id', $res, 'scratch_card', $delay_time1);
            }
            $delay_time2 = $input['end_time'] - time();
            if($delay_time2 > 0){
                $this->smallPromotionOpenOrClose('scratch_card_id', $res, 'scratch_card', $delay_time2);
            }
