 ...
 * PRIMARY KEY (rule_id)
 */
class VslPromotionMansongRuleModel extends BaseModel
{

    protected $table = 'vsl_promotion_mansong_rule';
    protected $rule = [
        'rule_id' => '',
    ];
    protected $msg = [
    ...
    public function promotion_man_song()
    {
        return $this->belongsTo('VslPromotionMansongModel', 'mansong_id', 'mansong_id');
    }
}