...
class Store extends Addons
{
    ...
    public $menu_info = array(
        ...
        [
            ...
            'icon_class' => 'icon-shop',//字体图标class（一般为空）
        ...
        [
            ...
            'icon_class' => '', // 字体图标class（一般为空）
            'is_control_auth' => 1, // 是否有控制权限
            'hook_name' => 'storeCommissionWithdrawList'
        ],
    );
    ...
    public function __construct()
    {
        ...
        if ($this->module == 'platform' || $this->module == 'admin') {
            $this->assign('storeCommissionWithdrawAuditUrl', __URL(addons_url_platform('store://Store/commissionWithdrawAudit')));
            $this->assign('storeCommissionWithdrawInfoUrl', __URL(addons_url_platform('store://Store/commissionWithdrawInfo')));
            $this->assign('getCommissionWithdrawCountUrl', __URL(addons_url_platform('store://Store/getWithdrawCount')));
            $this->assign('storeCommissionWithdrawListUrl', __URL(addons_url_platform('store://Store/commissionWithdrawList')));
     ...
     * 佣金提现列表
     */
    public function storeCommissionWithdrawList(){
        $this->fetch('template/platform/storeCommissionWithdrawList');
    }
    /*
     * 门店列表
     */
    ...
    {
        $storecashier = getAddons('storecashier', $this->website_id);
        $this->assign('storecashier', $storecashier);
