...
use addons\miniprogram\controller\Miniprogram as mpController;
...
//        var_dump(Db::table('')->getLastSql());
    ...
    public function createPoster()
    {
        ...
        if ($poster_id) {
            ...
            $data['type'] = $system_default_template_data['type'];
    ...
    public function getKindPoster()
    {
        ...
        if($poster_type == 2 && $goods_id){
            $is_goods_poster = $goodsSer->getGoodsDetailById($goods_id, 'goods_id,poster_data,is_goods_poster_open,px_type');
        ...
        return [
            ...
            'data' => [
                ...
                'poster_path' => $poster_res['poster'],
                'width' => $poster_res['width'],
                'height' => $poster_res['height'],
            ]
        ];
    }
