...
//                );
        ...
        public function areaBasicSetting()
        {
            ...
            if (request()->isPost()) {
                ...
                $areabonus_admin_status = request()->post('areabonus_admin_status', '');//是否开启店铺分红
                $retval = $config->setAreaBonusSite($areabonus_status,$agent_status,$agent_check, $agent_grade, $purchase_type,$areabonus_admin_status);
                if($retval){
