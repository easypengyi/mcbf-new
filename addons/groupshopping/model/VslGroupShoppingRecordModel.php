...
class VslGroupShoppingRecordModel extends BaseModel {
    ...
    public function getRecordDetail($record_id) {
        ...
        $recordDetail['goods'] = [];
        $goodsInfo = $goodsSer->getGoodsDetailById($recordDetail['goods_id'], 'goods_name,price,picture', 1);
        $recordDetail['goods']['goods_name'] = $goodsInfo['goods_name'];
        $recordDetail['goods']['pic_cover_mid'] = $goodsInfo['album_price']['pic_cover_mid'];
