...
{
    protected static $addons_name = 'coupontype';
    public $info = array(
    ...
    public function __construct()
    {
        ...
        if ($this->module == 'platform') {
            ...
            $this->assign('sendhistoryCouponUrl', __URL(addons_url_admin('coupontype://Coupontype/sendhistoryCoupon')));
        }
    }
    ...
    public function couponSetting()
    {
        ...
        $coupon_info = $addonsConfigSer->getAddonsConfig(self::$addons_name, $this->website_id);
    ...
    {
        $this->assign('coupon_type_id', $_GET['coupon_type_id']);
        $this->fetch('template/' . $this->module . '/sendhistoryCoupon');
    }
