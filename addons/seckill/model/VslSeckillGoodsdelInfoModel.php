...
//        $refused_total = objToArr($refused_total);
    ...
    public function refused_goods_list($page_index=1, $page_size, $condition, $order_by){
        $refused_total = $this->alias('nsdi')
            ->field('ns.seckill_id, g.goods_name, g.price, sap.pic_cover_big, nsg.seckill_price, nsg.seckill_num, nsg.remain_num, nsg.seckill_limit_buy, nsg.sku_id, g.goods_id, s.shop_name, ns.seckill_name, ns.seckill_time,ns.least_buy,nsdi.seckill_del_info')
