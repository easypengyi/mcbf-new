...
class GoodsTaskCalculate_1 extends Command {

    protected function configure() {
        $this->setName('goods_task_calculate_1')->setDescription('商品队列导入1');
    }
    ...
    public function execute(Input $input, Output $output) {
        ...
        try {
            ...
            $msg = 'GoodsTaskCalculate_1 行号:'.$e->getFile().' 错误信息:'.$e->getMessage();
