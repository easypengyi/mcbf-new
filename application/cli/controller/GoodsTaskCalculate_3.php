...
class GoodsTaskCalculate_3 extends Command {

    protected function configure() {
        $this->setName('goods_task_calculate_3')->setDescription('商品队列导入3');
    }
    ...
    public function execute(Input $input, Output $output) {
        ...
        while (1) {
            try {
                ...
                //$msg = 'GoodsTaskCalculate_3 行号:'.$e->getFile().' 错误信息:'.$e->getMessage();
                //debugFile($msg,'','public/goodshelper3.txt');
            }
        }
    }
