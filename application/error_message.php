...
define('DELETE_PROMOTIONGOODS_FAIL', -1013);
define('LOGIN_LACK_OF_PARAMETER', -1010);
define('PARAMETER_ERROR', -1011);
define('ADDONS_IS_NOT_EXIST', -1012);
...
define('SAME_PWD', -2022);
define('USER_NO_FOUND', -2023);
define('LEVEL_NO_FOUND', -2024);
...
define('PAY_PASS_LENGTH_ERROR', -8006);
//阿里云存储
...
define('SESSION_KEY_EXPIRE', -10018);
...
define('USER_GET_LIMIT', -10037);
//其他自定义
define('RECEIVE_GOODS_CODE_ERROR', -10100);
define('RECEIVE_GOODS_CODE_BINDED', -10101);
define('ABNORMAL_ACCOUNT', -2021);
define('STORE_CLOSE', -1099);
define('USER_IS_ADMIN', -8888);
...
function getErrorInfo($error_code)
{
    $system_error_arr = array(
        ...
        PAY_PASS_LENGTH_ERROR =>'支付密码长度不正确！',
        ADDONS_IS_NOT_EXIST =>'应用不存在',
        //用户变量定义
        USER_ERROR => '账号或者密码错误',
        USER_LOCK => '用户被锁定',
        USER_NBUND => '用户未绑定',
        ...
        NO_COUPON => '该券已被领完',
		USER_GET_LIMIT => '该券您领取达到了上限，不能再领取',
        GET_COUPON_FAIL => '领取失败',
        ...
        ABNORMAL_ACCOUNT => '账号异常',
        SAME_PWD => '新密码不能与旧密码相同',
        USER_NO_FOUND => '账号不存在',
        LEVEL_NO_FOUND => '等级不存在',
        ...
        SESSION_KEY_EXPIRE => 'session_key已过期',
        
        # 自定义
        RECEIVE_GOODS_CODE_ERROR => '领货码错误或过期',
        RECEIVE_GOODS_CODE_BINDED => '领货码已被绑定',
        STORE_CLOSE => 'O2O门店应用未开启',
        SUPPLIER_ORDER_CANT => '供应商订单退款只支持供应商操作',
        USER_IS_ADMIN => '会员已经是店铺卖家',
        USER_NO_WITHDRAW => '店铺账户余额不足',
    );
