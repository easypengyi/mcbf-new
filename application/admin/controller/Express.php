...
class Express extends BaseController {
    ...
    public function freightTemplateEdit() {
        ...
        if (request()->isAjax()) {
            ...
            $company_lists = $expressCompany->getExpressCompanyList(1, 0, $this->website_id, $this->instance_id, ['nr.website_id' => $this->website_id, 'nr.shop_id' => $this->instance_id, 'nr.supplier_id' => 0], '');
