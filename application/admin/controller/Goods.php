...
class Goods extends BaseController {
    ...
    public function __construct() {
        ...
        if($this->globalStatus){
            $global_config= new globalService();
            $globalStatusAdmin = $global_config->getGlobalBonusSite($this->website_id); 
            if($globalStatusAdmin['globalbonus_admin_status'] == 0){
                $this->globalStatus = 0;
            }
        }
        ...
        if($this->areaStatus){
            $area_config= new areaService();
            $areaStatusAdmin = $area_config->getAreaBonusSite($this->website_id); 
            if($areaStatusAdmin['areabonus_admin_status'] == 0){
                $this->areaStatus = 0;
            }
        }
        ...
        if($this->teamStatus){
            $team_config= new teamService();
            $teamStatusAdmin = $team_config->getTeamBonusSite($this->website_id); 
            if($teamStatusAdmin['teambonus_admin_status'] == 0){
                $this->teamStatus = 0;
            }
        }
    ...
    public function addGoods() { 
        ...
        if(getAddons('systemform',$this->website_id)){
            ...
            $systemform_list = $systemform_mdl->getQuery(['website_id' => $this->website_id,'shop_id' => $this->instance_id],'id,name','id asc');
