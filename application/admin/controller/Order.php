...
//        }
    ...
    public function getOrderCount()
    {
        ...
        if ($buyer_id) {
            $order_count_array['daifukuan'] = $order->getOrderCount(['order_status' => ['IN',[0,7]], 'website_id' => $this->website_id, 'shop_id' => $this->instance_id, 'buyer_id' => $buyer_id, 'is_deleted' => 0]); //代付款
            ...
            $order_count_array['daifukuan'] = $order->getOrderCount(['order_status' => ['IN',[0,7]], 'website_id' => $this->website_id, 'shop_id' => $this->instance_id, 'is_deleted' => 0]); //代付款
