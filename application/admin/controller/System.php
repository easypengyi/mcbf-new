...
class System extends BaseController {
    ...
    public function deleteCache() {
        ...
        $dateArr = $this->website->getWebCreateTime($this->website_id);
    ...
    public function planTask()
    {
        if (request()->isAjax()) {
            ...
            $data = [
                'data' => $return_data,
                'total_count' => ($goodsHelpList['total_count'] ?: 0) + ($invoice_files['total_count'] ?: 0) + ($delivery_files['total_count'] ?: 0) + ($electroncard_files['total_count'] ?: 0),
                'page_count' => ($goodsHelpList['page_count'] ?: 0) + ($invoice_files['page_count'] ?:0) + ($delivery_files['page_count'] ?: 0) + ($electroncard_files['page_count'] ?: 0)
            ];
