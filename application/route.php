...
//检测后台系统模块
   ...
   /************************************************************************************************检测入口文件*****************************************************************************************/
    ...
    if(strpos($_SERVER['QUERY_STRING'], '/wapbiz/addons/')){
        Route::rule('wapbiz/addons/:addons/:controller/:action','wapbiz/addons/execute','POST');
    }
    ...
    if(strpos($_SERVER['QUERY_STRING'], '/supplier/addons/goodhelper/')){
        Route::rule('supplier/addons/:addons/:controller/:action','supplier/addons/execute','POST');
    }
    ...
    $common_route = [
        ...
        '[rabbitTask]'     => [
            ...
            //商品列表
            ':action'         => ['shop/rabbitTask/:action'],
            '/'               => ['shop/rabbittask/load_task'],
        ],
        '[task]'     => [
