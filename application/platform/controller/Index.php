...
class Index extends BaseController
{
    ...
    public function index()
    {
        ...
        $list['b_set'] = $config->getConfig(0, 'BPAY', $this->website_id)['is_use'];
        ...
        $list['withdraw_set'] = $config->getConfig(0, 'WITHDRAW_BALANCE');
        ...
        $this->assign("custom_website_set", in_array(1, $type_arr) ? 1 : 0);
        $this->assign("custom_shop_set", in_array(2, $type_arr) ? 1 : 0);
        $this->assign("custom_member_set", in_array(4, $type_arr) ? 1 : 0);
