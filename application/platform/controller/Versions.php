...
class Versions extends BaseController
{
    ...
    public function logoConfig() {
        ...
        if (request()->isAjax()) {
            ...
            $params['supplier_logo'] = request()->post('supplier_logo','');
            ...
            $res = $config_service->setConfigOne($param);
            if($res){
        ...
        $this->assign('is_supplier', getAddons('supplier',$this->website_id));
