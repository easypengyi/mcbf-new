...
class BaseController extends Controller {
    ...
    public function __construct() {
        ...
        if(!IS_CLI){
            ...
            $copystyle = $web_config->getConfig(0,'COPYSTYLE',$website_id, 1);
            if($copystyle){
            ...
            if(!getAddons('pcport', $this->website_id) && !request()->get('suffix')){
                ...
                $redirect = __URLS('APP_MAIN/pages/mall/index');
                if($action=='goodsinfo'){
                    $goods_id = request()->get('goodsid',0);
                    $redirect = __URLS('APP_MAIN/packages/goods/detail').'?goods_id='. $goods_id;
                }
