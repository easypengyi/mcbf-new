...
class Components extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->login_verify_code = $web_config->getConfig(0,'LOGINVERIFYCODE', $this->website_id);
        // 是否开启通知
        $noticeMobile = $web_config->getConfig($instance_id, 'MOBILEMESSAGE', $this->website_id);
        $noticeEmail = $web_config->getConfig($instance_id, 'EMAILMESSAGE', $this->website_id);
