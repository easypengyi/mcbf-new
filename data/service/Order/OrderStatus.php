...
//                    ),
        ...
        if (($order_type == 5 || $order_type == 15) && $is_group_success > -1) {
            if ($is_group_success) {
                $status[1] = [
                    'status_id' => '1',
                    'status_name' => '已成团，待发货',
        ...
        if ($goods_type == 3 || $goods_type == 0 || $goods_type == 4 || $goods_type == 5) {//虚拟商品去掉部分操作
            ...
            unset($status[4]['member_operation'][2]);
        }
        return $status;
    }
