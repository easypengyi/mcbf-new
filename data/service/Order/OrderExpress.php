...
class OrderExpress extends BaseService
{
     ...
     *            物流单号
     */
    public function delivery($order_id, $order_goods_id_array, $express_name, $shipping_type, $express_company_id, $express_no, $delivery_num = 0, $express_company_name = '', $rec_id = 0)
    {
        $user = new UserModel();
        ...
        if(empty($this->website_id)) {
            ...
            $this->website_id = $order_mdl->Query(['order_id' => $order_id],'website_id')[0];
        }
        ...
        try {
                ...
                $data_goods_delivery = array(
                    ...
                    'express_company' => $express_company_info['company_name'] ?: $express_company_name,
                ...
                $order_goods->orderGoodsDelivery($order_id, $order_goods_id_array, $delivery_num);
