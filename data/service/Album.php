...
class Album extends BaseService
{
    ...
    public function getAlbumClassList($page_index = 1, $page_size = 0, $condition = '', $order = '', $field = '*')
    {
        ...
        $album = $album_class->getInfo(['website_id' => $this->website_id, 'shop_id' => $this->instance_id,'supplier_id'=>$this->supplier_id]);
        if(!$album){
     ...
     */
    public function addAlbumClass($aclass_name, $aclass_sort, $pid = 0, $aclass_cover = '', $is_default = 0, $instance_id = 1,$supplier_id=0)
    {
    ...
    {
        $album = $this->album_class->getInfo(['website_id' => $this->website_id, 'shop_id' => $this->instance_id,'supplier_id' => $this->supplier_id]);
        if(!$album){
            $this->addAlbumClass('默认相册', 0, 0, '', 1, $this->instance_id,$this->supplier_id);
        }
        // TODO Auto-generated method stub
...
//                 $res[$k]['pic_info'] = $pic_info;
    ...
    public function ModifyAlbumPicture($pic_id, $pic_cover, $pic_size, $pic_spec, $pic_cover_big, $pic_size_big, $pic_spec_big, $pic_cover_mid, $pic_size_mid, $pic_spec_mid, $pic_cover_small, $pic_size_small, $pic_spec_small, $pic_cover_micro, $pic_size_micro, $pic_spec_micro, $instance_id, $upload_type, $domain, $bucket,$website_id=0,$supplier_id = 0)
    {
        ...
        $data = array(
            ...
            "bucket" => $bucket,
            "website_id" => $website_id?:$this->website_id,
            "shop_id" => $instance_id?:$this->instance_id,
            "supplier_id" => $supplier_id?:$this->supplier_id,
        );
    ...
    public function getGoodsAlbumUsePictureQuery($condition)
    {
        ...
        // TODO Auto-generated method stub
        $goodsSer = new Goods();
        $goods_query = $goodsSer->getGoodsListByCondition($condition, "img_id_array");
    ...
    public function getDefaultAlbumDetail(){
        $res = $this->album_class->getInfo($condition = [
            "website_id" => $this->website_id,
            "shop_id" => $this->instance_id,
     ...
     */
    public function getDefaultAlbum($website_id = 0,$shop_id = 0,$supplier_id=0){
        $res = $this->album_class->getInfo([
            "shop_id" => $shop_id,
